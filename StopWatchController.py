...
class StopWatchController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button1 = Button(16, "start", buttonhandler=None)
        self._button2 = Button(17, "stop", buttonhandler=None)
    ...
    def stateEntered(self, state, event):
        ...
        if state == 0:
            ...
            self._display.showText("Ready! Press the red button")
    ...
    def stateLeft(self, state, event):
        if state == 1:
            self._timekeeper.stop()
            self._buzzer.beep(200,50)
        
        elif state == 2:
            self._timekeeper.reset()
            self._buzzer.beep(100,150)
